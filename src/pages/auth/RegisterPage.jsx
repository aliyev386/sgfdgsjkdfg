          ...
          <form onSubmit={handleSubmit} noValidate>
            <div className="auth-row">
              <div className="auth-field">
                <label className="auth-field-label" htmlFor="reg-name">{t.name}</label>
              ...
              <div className="auth-field">
                <label className="auth-field-label" htmlFor="reg-surname">{t.surname}</label>
                <div className="auth-input-wrap">
                  <span className="auth-input-icon"><IconUser /></span>
            ...
            <div className="auth-field">
              <label className="auth-field-label" htmlFor="reg-email">{t.email}</label>
              <div className="auth-input-wrap">
            ...
            <div className="auth-field">
              <label className="auth-field-label" htmlFor="reg-phone">
                {t.phone} <span style={{ color: "#9ca3af", fontWeight: 400 }}>{t.phoneOpt}</span>
              </label>
              <div className="auth-input-wrap">
            ...
            <div className="auth-row">
              <div className="auth-field">
                <label className="auth-field-label" htmlFor="reg-password">{t.password}</label>
                <div className="auth-input-wrap">
              ...
              <div className="auth-field">
                <label className="auth-field-label" htmlFor="reg-confirm">{t.confirm}</label>
                <div className="auth-input-wrap">
