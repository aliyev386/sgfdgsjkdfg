...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setAlert(null);
    try {
      // register artıq tokenləri localStorage-ə saxlayır
      ...
      // Real user məlumatlarını al
      let user = { email: form.email, name: form.name, surname: form.surname };
      try { user = await getMe(); } catch { /* default user-i saxla */ }
      ...
      <div className="auth-right">
        <div className="auth-form-container">
          ...
          <button type="button" className="auth-btn-google" onClick={triggerGoogleLogin} disabled={googleLoading} style={{ marginBottom: "8px" }}>
            {googleLoading
              ? (<><div className="auth-spinner" style={{ borderTopColor: "#aa3bff", borderColor: "#e5e4e7" }} />Google ilə qeydiyyat...</>)
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="auth-row">
              <div className="auth-field">
                <label className="auth-field-label" htmlFor="reg-name">Ad *</label>
              ...
              <div className="auth-field">
                <label className="auth-field-label" htmlFor="reg-surname">Soyad *</label>
                <div className="auth-input-wrap">
                  <span className="auth-input-icon">👤</span>
              ...
              <div className="auth-field">
                ...
                <div className="auth-input-wrap">
                  ...
                  <input id="reg-confirm" type={showConfirm ? "text" : "password"} name="confirmPassword"
                    ...
                    placeholder="Şifrənizi yenidən daxil edin" value={form.confirmPassword} onChange={handleChange} autoComplete="new-password" disabled={loading} />
